**Table 1 | Summary of experiments.** All runs 8–9 September 2026. Astra = GPT-6 Astra via API at two reasoning efforts; Fable = Claude Fable 5.1 as Claude Code sub-agents; grader = GPT-5.6 Sol with fixed boolean rubrics, spot-read by the author. Full rubrics, prompts and transcripts in Supplementary Information.
